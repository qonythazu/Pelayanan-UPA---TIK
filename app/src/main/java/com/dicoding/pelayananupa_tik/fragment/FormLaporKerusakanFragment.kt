 ...
 * Use the [FormLaporKerusakanFragment.newInstance] factory method to
...
class FormLaporKerusakanFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FormLaporKerusakanFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FormLaporKerusakanFragment().apply {
