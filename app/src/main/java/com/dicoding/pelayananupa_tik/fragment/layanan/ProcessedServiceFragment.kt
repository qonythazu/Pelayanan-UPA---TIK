...
class ProcessedServiceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_processed_service, container, false)
    ...
    private fun updateUI() {
        ...
        if (layananList.isEmpty()) {
            ...
            emptyStateTextView.text = getString(R.string.belum_ada_layanan_yang_dalam_proses_pengerjaan)
        } else {
